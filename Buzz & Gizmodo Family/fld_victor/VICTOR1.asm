...
PS_my_bx equ PS_end_of_reset_all+5
PS_other_bx equ PS_end_of_reset_all+10
PS_my_ax equ PS_other_bx+10
_sw equ 0A5h
_sb equ 0A4h
...
mov al,0A3h
mov sp,ax 
sub sp,8104h ; adjust this number to run over self with 0A5h. puts the stack-pointer
